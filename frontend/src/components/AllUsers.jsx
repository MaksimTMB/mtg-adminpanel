          ...
          {nodes.map(node => {
            ...
            return (
              <div className="card" key={node.id}>
                {/* Node header */}
                <div className="all-users-node-head" style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom: users.length ? 16 : 0}}>
                  <div className="all-users-node-meta" style={{display:'flex',alignItems:'center',gap:10}}>
                    {node.flag
                  ...
                  <div className="all-users-node-actions" style={{display:'flex',alignItems:'center',gap:8}}>
                    {users.length > 0 && (
                      <div className="all-users-node-badges" style={{display:'flex',gap:6}}>
